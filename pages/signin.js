        ...
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          <div className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
            <div className="text-center">
              <p
                className="mt-1 text-4xl font-extrabold text-neutral-800 sm:text-5xl sm:tracking-tight lg:text-6xl">Signed
                In.</p>
              <p className="max-w-xl mt-5 mx-auto text-xl text-neutral-500">You may return to where you were. Or
                click&nbsp;
